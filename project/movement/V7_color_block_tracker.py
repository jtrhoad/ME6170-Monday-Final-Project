...
# If both sides are blocked, rotate 180 and drive away.
TRAPPED_THRESHOLD_CM   = OBSTACLE_DISTANCE_CM

# --- Escape (180 + drive) when trapped ---
ESCAPE_FORWARD_DURATION = 1.5
...
def draw_overlay(frame, target, tracker):
    ...
    if tracker.state in (AVOIDING, SCANNING_OBSTACLE, ESCAPE_BACKWARD):
        dr = tracker.dr
        cv2.putText(frame,
